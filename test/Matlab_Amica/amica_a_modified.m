...
tic
[A,c,LL,Lt,gm,alpha,mu,beta,rho] = amica_a_m(x,1,3,538,1);
%[A,c,LL,Lt,gm,alpha,mu,beta,rho] = amica_a(x,1,3,100,1);
toc
function [A,c,LL,Lt,gm,alpha,mu,beta,rho] = amica_a_m(x,M,m,maxiter,update_rho,mindll,iterwin,do_newton,remove_mean,As,cs)
...
for iter = 1:maxiter
    ...
    for h = 1:M
        switch 1
            ...
            case 2 %just to test different calc of Lt
